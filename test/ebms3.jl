...
@testset "parse Receipt with NRI digests" begin
  raw = signal(
    "<eb:Timestamp>2026-06-11T00:00:00.000Z</eb:Timestamp><eb:MessageId>r1@ato</eb:MessageId><eb:RefToMessageId>m1@sender.example</eb:RefToMessageId>",
  ...
  @test r isa Receipt
  @test r.ref_to_message_id == "m1@sender.example"
  @test r.digests == ["#soapbody" => "q83vEjRWeJA="]
end

@testset "parse ebMS Error / empty MPC" begin
  raw = signal(
    "<eb:Timestamp>2026-06-11T00:00:00.000Z</eb:Timestamp><eb:MessageId>e1@ato</eb:MessageId><eb:RefToMessageId>m2@sender.example</eb:RefToMessageId>",
  ...
  @test isempty_mpc(e)
  @test e.ref_to_message_id == "m2@sender.example"
end
